...
fn main() {
    ...
    loop {
        ...
        /*let mut coord:(usize, usize, usize, usize) = (h, w, 0, 0);
        for y in 0..h {
            for x in 0..w {
                for i in 0..3 {
                    for j in 0..4 {
                        if !visited[y][x][i][j] {
                            if coord.0 == h {
                                coord = (y, x, i, j);
                            } else if labels[y][x][i][j] < labels[coord.0][coord.1][coord.2][coord.3] {
                                coord = (y, x, i, j);
                            }
                        }
                    }
        ...
        let curlabel = labels[coord.0][coord.1][coord.2][coord.3];
        */
        if curlabel == u32::MAX {
            break;
        }
